...
export default function SaveCodeTemplate({ code, language, isOpen, onClose, onSwitchToLogin  }: SaveCodeTemplateProps) {
    ...
    const handleSaveClick = () => {
        ...
        if (!user) {
            setShowLoginConfirm(true); // Show confirmation instead of immediate redirect
            return;
        }
                ...
                <div className={`relative w-full max-w-md rounded-xl shadow-2xl ${
                    ...
                    <div className="p-6">
                        ...
                        <p className={`mb-6 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                            You need to be logged in to save code templates. Would you like to login now?
                        </p>
